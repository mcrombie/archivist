...
// Every theme restyles the same interface. None changes answers, evidence, or the perspective.
export const VIBES = [
  { id: "cradle", label: "Cradle of the Empire", description: "The book's own cover: ivory parchment, engraved sepia, pine, and slate." },
...
// Archivist is one book's reading room, so every visit opens in that book's own theme.
export const DEFAULT_VIBE: VibeId = "cradle";
