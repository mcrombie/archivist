...
`$7.00` authorization. H002, H003, H021, H025, and H026 each reached the provider boundary once but produced no
...
Their cumulative `$2.001781250` reserve lowers the dynamic tracked ceiling to `$4.998218750`.
