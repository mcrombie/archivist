...
AMBIGUITY_RECOVERY_DECLARATIONS: Mapping[str, Mapping[str, object]] = {
    ...
    "H021": {
        "sequence": 2,
        "turn_id": "H021:generation",
        "previous_recovery_harness_commit": (
            "d4143c779e75fdf850d302583ec6fde2f1ce0979"
        ),
        "previous_continuation_file": "ambiguity-continuations/0001-H003.json",
        "generation_intent_file_sha256": (
            "8ccac460a72f35657796c5f71bca0e4ae09e9ce0ad668dd1302f1831d03947e4"
        ),
        "generation_intent_canonical_sha256": (
            "1cb8df6d517bb5f0eafb90d00eae31ada2b7d734622166bb1ca14fae2bacb5dc"
        ),
        "generation_outcome_file_sha256": (
            "16c6e6d2cdcebc032abb23ecda51b15a5cfc1cb8f3a840b5561662cce4fd4cd9"
        ),
        "generation_outcome_canonical_sha256": (
            "c3eb3ebb130f2abf8941354a052a8582bbd67f1a5216fa0882d33632be181f98"
        ),
        ...
        "provider_request_serialized_bytes": 21_410,
        "provider_request_token_overhead_upper_bound": 32_768,
        "provider_input_token_upper_bound": 54_178,
        "max_output_tokens": 1_800,
        "projected_worst_case_reserved_nano_usd": 392_612_500,
        "request_binding_sha256": (
            "5ec831a3895f1c47be49a0a00accdb50cd7c51be0d0ad72dcb78b9e84c1165c7"
        ),
        "next_item_id": "H022",
        "later_generation_item_ids_sha256": (
            "9999fcadbf9b834f2b3f8c33dd3846bac0e255ec6788c1dca8137c2065c293aa"
        ),
    },
    "H025": {
        "sequence": 3,
        "turn_id": "H025:generation",
        "previous_recovery_harness_commit": (
            "ae6b579b34e23005302d274d9f2ff3d2be2d52e9"
        ),
        "previous_continuation_file": "ambiguity-continuations/0002-H021.json",
        "generation_intent_file_sha256": (
            "7ed3889d3e73dd9b9057c2a0fc99a0570a998767f0f6dbc28a0b1b05b8a40e42"
        ),
        "generation_intent_canonical_sha256": (
            "599db1a0f562280d28aa8561aba3be4bc3aee3cb052561c51f8cd3337cfe83f2"
        ),
        "generation_outcome_file_sha256": (
            "eea018822db00a3378a64dbd2fac79153ece7b876cbe60a2dfe2b2a406abb21b"
        ),
        "generation_outcome_canonical_sha256": (
            "cf94a54fdca163811b5913e6bdb01a5dc526addf9f5512384a5d5d9b64ec5e2f"
        ),
        "previous_continuation_file_sha256": (
        ...
        "provider_request_serialized_bytes": 23_481,
        "provider_request_token_overhead_upper_bound": 32_768,
        "provider_input_token_upper_bound": 56_249,
        "max_output_tokens": 1_800,
        "projected_worst_case_reserved_nano_usd": 405_556_250,
        "request_binding_sha256": (
            "de0060d3299973783267fd02d959b721ea12373eadf5e2497194852c7e5f9044"
        ),
        "next_item_id": "H026",
        "later_generation_item_ids_sha256": (
            "7850d82fd6ad7fefb0d2dd21cf8acf489a00a4ce8e4ff04c4520fa1de3cc5124"
        ),
    },
    "H026": {
        "sequence": 4,
        "turn_id": "H026:generation",
        "previous_recovery_harness_commit": (
            "7d8b50904d05e8bcd7b33f11ef1d2cf6943d79df"
        ),
        "previous_continuation_file": "ambiguity-continuations/0003-H025.json",
        "generation_intent_file_sha256": (
            "d96c7c10b4b54d90732a73d9d4907a3a93e28450c41a0d29c84f6159bb05f7c4"
        ),
        "generation_intent_canonical_sha256": (
            "23920cde225d2304d8398b004e0587b0f9f6160cdb0a5a3008cd0d2857a98add"
        ),
        "generation_outcome_file_sha256": (
            "f14d8e0c6ca0844faf9a58271a48a5f479ed6ed9ad55601771b9cfb206189f47"
        ),
        "generation_outcome_canonical_sha256": (
            "04d4e26b02b68c5795ef11de5da33b0391ce313cd92fca01e37c44977df54f11"
        ),
        "previous_continuation_file_sha256": (
        ...
        "provider_request_serialized_bytes": 23_533,
        "provider_request_token_overhead_upper_bound": 32_768,
        "provider_input_token_upper_bound": 56_301,
        "max_output_tokens": 1_800,
        "projected_worst_case_reserved_nano_usd": 405_881_250,
        "request_binding_sha256": (
            "d86b1a5cd99c0f34b5962109b306aa110417ea7060460f5f9b913b890bf7159f"
        ),
        "next_item_id": "H027",
        "later_generation_item_ids_sha256": (
            "9723623b6ec36353d5837705057a0cdf8e189dbacb724968adf2e9d90cdb5cf7"
        ),
    },
    "H027": {
        "sequence": 5,
        "turn_id": "H027:generation",
        "previous_recovery_harness_commit": (
            "b1a79f79b64b341be140a5d15fbbfe510099417b"
        ),
        "previous_continuation_file": "ambiguity-continuations/0004-H026.json",
        "generation_intent_file_sha256": (
            "be28db6792991a1991802b77b77e3c10ea67562e5757d4db28c875395129f4db"
        ),
        "generation_intent_canonical_sha256": (
            "6b23bc34d6a8d63586d81c89674967f676544ca2b05b143fc4b2e942ab7a3d03"
        ),
        "generation_outcome_file_sha256": (
            "c2118e787f48e6ab69bbdf7154bb272a8cddf56ff7f8b054f6390f68c3547cbf"
        ),
        "generation_outcome_canonical_sha256": (
            "2e438610328e314967f3f66e34addd756b707490b563bbcdbf39a54445041f26"
        ),
        "previous_continuation_file_sha256": (
        ...
        "provider_request_serialized_bytes": 21_064,
        "provider_request_token_overhead_upper_bound": 32_768,
        "provider_input_token_upper_bound": 53_832,
        "max_output_tokens": 1_800,
        "projected_worst_case_reserved_nano_usd": 390_450_000,
        "request_binding_sha256": (
    ...
    "H013:decomposition": {
        ...
        "previous_continuation_file": (
            "ambiguity-continuations/0008-H012-decomposition.json"
        ),
        "intent_file_sha256": (
            "2b3307ce477ac994e5910621d541a56a837c007a0b0107fb01eab63714b10c2a"
        ),
        "intent_canonical_sha256": (
            "3fc301319d7913de3f2a2f4496d015cf9a5b03ce944aa2d7a59c396ecb60858f"
        ),
        "outcome_file_sha256": (
            "8ef5f44565f37468ca63146b415926405da5b823b211d7ec757391ad96ba8920"
        ),
        "outcome_canonical_sha256": (
            "5faeddedea82df560fc726f16961b9f5a17bd984b1e8e535348a768c9620ab85"
        ),
        "previous_continuation_file_sha256": (
        ...
        "provider_request_serialized_bytes": 5_437,
        "provider_request_token_overhead_upper_bound": 32_768,
        "provider_input_token_upper_bound": 38_205,
        "max_output_tokens": 4_000,
        "projected_worst_case_reserved_nano_usd": 179_390_625,
        "request_binding_sha256": (
            "4a859757dfdc9d8d8343427be9ab5ce70f2d1a77dd1d6acaa12f1fa4f00610a1"
        ),
        "next_item_id": "H014",
        "next_turn_id": "H014:decomposition",
        "later_phase_turn_ids_sha256": (
